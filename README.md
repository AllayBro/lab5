...
Если хотите, могу:
- заменить docker-compose на использование build: контекстов и закоммитить изменения;
- добавить простую инструкцию запуска с docker-compose build;
- проверить Dockerfile каждого сервиса (убедиться, что ENTRYPOINT запускает собранный JAR).
